...
public class FoodProductsPagerView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_products_pager_view);
        init();
    }
    private void init() {
        ...
        mPager.setAdapter(new MyAdapter_Pager(FoodProductsPagerView.this,XMENArray));
