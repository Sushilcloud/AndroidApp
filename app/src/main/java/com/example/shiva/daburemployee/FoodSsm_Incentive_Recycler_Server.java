...
public class FoodSsm_Incentive_Recycler_Server extends AppCompatActivity {

    ImageView imageView;

    private static final String TAG="FoodSsm_Incentive_Recycler_Server";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_ssm__incentive__recycler__server);
